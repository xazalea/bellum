...
export class NetworkTunnel {
    ...
    private async connectWebTransport() {
        ...
        console.log('Challenger Network Tunnel Connected (WebTransport)');
    ...
    private async connectWebSocket(): Promise<void> {
        return new Promise((resolve, reject) => {
            ...
            this.socket.onopen = () => {
                this.isConnected = true;
                console.log('Challenger Network Tunnel Connected (WebSocket)');
                resolve();
            };
    ...
    private handleMessage(data: ArrayBuffer | Uint8Array): void {
        ...
        // Event dispatch (mock)
        const event = new CustomEvent('challenger-network-packet', { detail: packet });

...
/**
 * DalvikDecoder: Decodes Android DEX bytecode into Challenger IR.
...
export class DalvikDecoder {
    ...
    /**
     * Mocks the decoding of a typical Android 'onCreate' method into Challenger IR.
    ...
    private simulateInstructionStream(block: BasicBlock) {
        ...
        // 4. tv.setText("Hello Challenger!");
        // const-string v2, "Hello Challenger!"
        block.addInstruction(Opcode.MOVE, { type: 'REG', value: 4 }, { type: 'IMM', value: "Hello Challenger!" });

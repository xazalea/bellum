...
export const metadata: Metadata = {
  ...
  description:
    "Run Android, Windows, and 20,000+ games directly in your browser. No downloads. No installs. Just pure web-native power.",
  keywords: [
    "abyss os",
    "challenger deep",
    "android in browser",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`dark ${inter.variable}`}>
      ...
      <body
        className={`${inter.className} min-h-screen bg-[#01040a] text-[#f0f9ff] antialiased`}
      >
        {/* Background Effects */}

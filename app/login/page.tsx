    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-sm px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-9 px-3 text-[11px] bg-card border border-border text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-foreground/20 transition-colors rounded-sm"
              required
            />
          </div>
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-[9px] text-muted-foreground/30 uppercase tracking-wider">or</span>
          <div className="flex-1 h-px bg-border" />
        </div>

        {/* Social login */}
        <div className="space-y-2">
          <button className="btn-secondary w-full text-[11px]">
          ...
          <button className="btn-secondary w-full text-[11px]">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="mr-2 opacity-70">

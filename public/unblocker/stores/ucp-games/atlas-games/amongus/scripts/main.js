...
(window.DOMHandler = class {
  ...
  (window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnCreate(e) {
      ...
      s.addEventListener("focus", (e) => this._OnFocus(t)),
        s.addEventListener("blur", (e) => this._OnBlur(t)),
        this._autoAttach && document.body.appendChild(i);
    }
    CreateElement(e, t) {
    ...
    _OnSetVisible(e) {
      this._autoAttach &&
        (this._elementMap.get(e.elementId).style.display = e.isVisible
          ? ""
          : "none");
    }
    _OnUpdatePosition(e) {
  ...
  });
{
  ...
  function t(e, t) {
    ...
    if (((i.async = !1), "module" === t && (i.type = "module"), !e.isStringSrc))
  ...
  window.RuntimeInterface = class i {
    constructor(e) {
      (this._useWorker = e.useWorker),
        ...
        (this._scriptsType = e.scriptsType),
    ...
    async _Init(e) {
      if ("playable-ad" === this._exportType) {
        ...
        for (let t = 0, i = e.engineScripts.length; t < i; ++t) {
          ...
          this._localFileStrings.hasOwnProperty(i)
            ? (e.engineScripts[t] = {
                isStringSrc: !0,
                str: this._localFileStrings[i],
              })
            : this._localFileBlobs.hasOwnProperty(i) &&
              (e.engineScripts[t] = URL.createObjectURL(
                this._localFileBlobs[i]
              ));
        }
      }
    ...
    _GetWorkerURL(e) {
      let t;
      return (
        (t = this._workerScriptURLs.hasOwnProperty(e)
          ? this._workerScriptURLs[e]
          ...
          ? this._localFileBlobs[e.toLowerCase()]
          : e),
    ...
    async CreateWorker(e, t, i) {
      ...
      if (this.IsiOSCordova() && "file:" === location.protocol) {
        const t = await this.CordovaFetchLocalFileAsArrayBuffer(
            this._scriptFolder + e
          ),
          s = new Blob([t], { type: "application/javascript" });
    ...
    async _InitWorker(e, t) {
      ...
      document.body.appendChild(this._canvas),
        ...
        this._worker.postMessage(
          ...
          [t, s, ...this._jobScheduler.GetPortTransferables()]
        ),
        (this._domHandlers = u.map((e) => new e(this))),
    ...
    async _InitDOM(e, i) {
      (this._canvas = document.createElement("canvas")),
        ...
        (this._domHandlers = u.map((e) => new e(this))),
        this._FindRuntimeDOMHandler();
      const s = e.engineScripts.map((e) =>
        "string" == typeof e ? new URL(e, this._baseUrl).toString() : e
      );
      Array.isArray(e.workerDependencyScripts) &&
        s.unshift(...e.workerDependencyScripts),
        await Promise.all(s.map((e) => t(e, this._scriptsType)));
      ...
      if ("module" === this._scriptsType) {
        ...
        for (let [e, o] of s)
          if ((o || (o = e), e === i))
            ...
            ("scriptsInEvents.js" === e || e.endsWith("/scriptsInEvents.js")) &&
              (await t(o, this._scriptsType));
      } else if (e.projectScripts && e.projectScripts.length > 0)
        try {
          if (
            (await Promise.all(
              e.projectScripts.map((e) => t(e[1], this._scriptsType))
            ),
            Object.values(n).some((e) => !e))
          )
            return void self.setTimeout(
              () => this._ReportProjectScriptError(n),
              100
            );
        } catch (e) {
          return (
            console.error("[Preview] Error loading project scripts: ", e),
            void self.setTimeout(() => this._ReportProjectScriptError(n), 100)
          );
        }
      if (
        "preview" === this._exportType &&
      ...
      this._OnBeforeCreateRuntime(),
        (this._localRuntime = self.C3_CreateRuntime(o)),
        await self.C3_InitRuntime(this._localRuntime, o);
    }
    _ReportProjectScriptError(e) {
      this._RemoveLoadingMessage();
      const t = `Failed to load project script '${
        Object.entries(e)
          .filter((e) => !e[1])
          .map((e) => e[0])[0]
    ...
    _ReportProjectMainScriptError(e, t) {
      this._RemoveLoadingMessage(),
        console.error(
          `[Preview] Failed to load project main script (${e}): `,
          t
        ),
        alert(
          `Failed to load project main script (${e}). Check all your JavaScript code has valid syntax. Press F12 and check the console for error details.`
        );
    }
    ...
    _RemoveLoadingMessage() {
      ...
      e &&
        (e.parentElement.removeChild(e), (window.cr_previewLoadingElem = null));
    }
    ...
    _OnMessageFromRuntime(e) {
      ...
      if ("result" === t) this._OnResultFromRuntime(e);
        ...
        this._RemoveLoadingMessage(), alert(e.message);
      else {
    ...
    _OnEventFromRuntime(e) {
      ...
      if (!a)
        return void console.warn(
          `[DOM] No handler '${i}' for component '${t}'`
        );
      let r = null;
      try {
        r = a(s);
        ...
        return (
          console.error(`Exception in '${t}' handler '${i}':`, e),
          void (null !== n && this._PostResultToRuntime(n, !1, "" + e))
        );
      }
      if (null === n) return r;
      r && r.then
        ? r
            .then((e) => this._PostResultToRuntime(n, !0, e))
            .catch((e) => {
              console.error(`Rejection from '${t}' handler '${i}':`, e),
                this._PostResultToRuntime(n, !1, "" + e);
            })
    ...
    _PostResultToRuntime(e, t, i) {
      ...
      i && i.transferables && (s = i.transferables),
        this._messageChannelPort.postMessage(
          { type: "result", responseId: e, isOk: t, result: i },
          s
        );
    }
    ...
    AddRuntimeComponentMessageHandler(e, t, i) {
      let s = _.get(e);
      if ((s || ((s = new Map()), _.set(e, s)), s.has(t)))
    ...
    async RequestPermissions(e) {
      ...
      for (const t of e)
        if (
          !(await this._HasPermission(t)) &&
          !1 === (await this._RequestPermission(t))
        )
          return !1;
      return !0;
    }
    ...
    async _ConvertDataUrisToBlobs() {
      ...
      for (const [t, i] of Object.entries(this._localFileBlobs))
        e.push(this._ConvertDataUriToBlobs(t, i));
      await Promise.all(e);
    }
    async _ConvertDataUriToBlobs(e, t) {
      if ("object" == typeof t)
        ...
        i || (i = this._DataURIToBinaryBlobSync(t)),
    ...
    _ParseDataURI(e) {
      ...
      return (
        (d =
          "base64" === a || "base64" === r ? atob(s) : decodeURIComponent(s)),
        { mime_type: o, data: d }
      );
    }
...
}
{
  ...
  const i = new Map([
    ...
    n = { dispatchUserScriptEvent: !0 },
    o = { dispatchRuntimeEvent: !0 };
  async function a(e) {
  ...
  async function d(e, t, i) {
    ...
    return (
      o.setAttribute("width", t + "px"),
      o.setAttribute("height", i + "px"),
      (s = new XMLSerializer().serializeToString(n)),
      (e = new Blob([s], { type: "image/svg+xml" })),
      await a(e)
    );
  }
  function c(e) {
  ...
  (self.C3_GetSvgImageSize = async function (e) {
    ...
    (self.C3_RasterSvgImageBlob = async function (e, t, i, s, n) {
      ...
      return (
        (a.width = s),
        (a.height = n),
        a.getContext("2d").drawImage(o, 0, 0, t, i),
        a
      );
    });
  let _ = !1;
  ...
  function p() {
    ...
    return (
      "textarea" === t ||
      ("input" === t ? i.has(e.type.toLowerCase() || "text") : c(e))
    );
  }
  document.addEventListener("pause", () => (_ = !0)),
    document.addEventListener("resume", () => (_ = !1));
  const f = "runtime",
    g = class extends self.DOMHandler {
      constructor(e) {
        super(e, f),
          ...
          e.AddRuntimeComponentMessageHandler("canvas", "update-size", (e) =>
        ...
        window.addEventListener("selectstart", h),
          ...
          i.addEventListener("gesturehold", h),
      ...
      Attach() {
        window.addEventListener("focus", () =>
          ...
          window.addEventListener("blur", () => {
            this._PostRuntimeEvent("window-blur", { parentHasFocus: m() }),
              (this._mousePointerLastButtons = 0);
          }),
      ...
      _OnFullscreenError(t) {
        console.warn("[Construct 3] Fullscreen request failed: ", t),
      ...
      _OnMouseEventAsPointer(e, i) {
        ...
        (("pointerdown" === e && 0 !== o) ||
          ...
          (this._mousePointerLastButtons = i.buttons),
          this._OnMouseEvent(i.type, i, n);
      }
      _OnPointerEvent(e, t) {
        ...
        if (
          ...
          "pointerdown" === e
            ? (i = "mousedown")
            : "pointerup" === e && (i = "mouseup"),
            this._OnMouseEvent(i, t, n),
      ...
      _OnDeviceMotion(e) {
        ...
        r &&
          (a = { alpha: r.alpha || 0, beta: r.beta || 0, gamma: r.gamma || 0 }),
          this.PostToRuntime(
            "devicemotion",
            {
              acceleration: t,
      ...
      _OnUpdateCanvasSize(e) {
        const t = this.GetRuntimeInterface(),
          i = t.GetCanvas();
        (i.style.width = e.styleWidth + "px"),
          (i.style.height = e.styleHeight + "px"),
          (i.style.marginLeft = e.marginLeft + "px"),
          (i.style.marginTop = e.marginTop + "px"),
          t.MaybeForceBodySize(),
          this._isFirstSizeUpdate &&
            ((i.style.display = ""), (this._isFirstSizeUpdate = !1));
      }
      _OnInvokeDownload(e) {
        const t = e.url,
          i = e.filename,
  ...
  self.JobSchedulerDOM = class {
    constructor(e) {
      (this._runtimeInterface = e),
        ...
        "preview" === e.GetExportType()
          ? (this._baseUrl += "c3/workers/")
          : (this._baseUrl += e.GetScriptFolder()),
    ...
    async Init() {
      ...
      (this._inputPort = i.port1),
        this._dispatchWorker.postMessage(
          { type: "_init", "in-port": i.port2 },
          [i.port2]
        ),
    ...
    async _CreateJobWorker() {
      ...
      return (
        this._dispatchWorker.postMessage(
          { type: "_addJobWorker", port: n.port1 },
          [n.port1]
        ),
        s.postMessage(
          {
...
}
{
  ...
  (self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    async _CreateAudioContext(e) {
      ...
      if (
        (this.SupportsWebMOpus() || (t.sampleRate = 48e3),
    ...
    _UnblockAudioContext() {
      ...
      (i.buffer = t),
        ...
        i.start(0),
        "running" === e.state && this._DetachUnblockEvents();
    }
    GetAudioContext() {
    ...
    _ReconnectEffects(e) {
      ...
      if (i && i.length) {
        ...
        for (let e = 0, t = i.length; e < t; ++e) {
          const s = i[e];
          e + 1 === t
            ? s.ConnectTo(this.GetDestinationNode())
            : s.ConnectTo(i[e + 1].GetInputNode());
        }
      }
    ...
    *audioInstancesByTag(e) {
      if (e)
        for (const t of this._audioInstances)
          self.AudioDOMHandler.EqualsNoCase(t.GetTag(), e) && (yield t);
      else
    ...
    PostTrigger(e, t, i) {
      this.PostToRuntime("trigger", { type: e, tag: t, aiid: i });
    }
    async _Play(e) {
      ...
      try {
        (this._lastAudioInstance = await this._GetAudioInstance(t, i, s, o, n)),
          c
            ? (this._lastAudioInstance.SetPannerEnabled(!0),
              ...
              c.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(c.uid))
            : this._lastAudioInstance.SetPannerEnabled(!1),
          this._lastAudioInstance.Play(a, r, d, l);
      } catch (e) {
    ...
    _OnTick(e) {
      ...
      for (const t of e.instPans) {
        ...
        for (const i of this._audioInstances)
          i.GetUID() === e && i.SetPanXYA(t.x, t.y, t.angle);
      }
    }
    async _AddEffect(e) {
      const t = e.type,
      ...
      if ("filter" === t) n = new self.C3AudioFilterFX(this, ...s);
        ...
        (n = new self.C3AudioConvolveFX(this, t.GetAudioBuffer(), ...s)),
    ...
    async _OnLoadState(e) {
      ...
      for (const e of this._effects.values()) for (const t of e) t.Release();
      this._effects.clear(),
        (this._timeScale = e.timeScale),
        (this._gameTime = e.gameTime);
      const i = e.listenerPos;
      ...
      for (const t of Object.values(e.effects))
        s.push(Promise.all(t.map((e) => this._AddEffect(e))));
      await Promise.all(s),
    ...
    async _LoadAudioInstance(e, t) {
      ...
      l.LoadPanState(e.pan),
        l.Play(r, d, c, 0),
        e.isPlaying || l.Pause(),
        l._LoadAdditionalState(e);
    }
...
(self.C3AudioBuffer = class {
  ...
  static Create(e, t, i, s, n) {
    ...
    return (
      n && o && e._SetHasAnySoftwareDecodedMusic(),
      !n || e.IsPlayMusicAsSound() || o
        ? new self.C3WebAudioBuffer(e, t, i, s, n, o)
        : new self.C3Html5AudioBuffer(e, t, i, s, n)
    );
  }
  CreateInstance(e) {
    return "html5" === this._api
      ? new self.C3Html5AudioInstance(this._audioDomHandler, this, e)
      : new self.C3WebAudioInstance(this._audioDomHandler, this, e);
  }
  _Load() {}
  Load() {
    return (
  ...
  (self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
    ...
    async _Fetch() {
      ...
      if (
        "cordova" === e.GetExportType() &&
        e.IsRelativeURL(this._url) &&
  ...
  });
{
  ...
  self.C3AudioInstance = class {
    constructor(t, i, s) {
      ...
      (this._isTimescaled = (1 === n && !this.IsMusic()) || 2 === n),
        (this._instUid = -1),
        (this._fadeEndTime = -1),
    ...
    SetPan(e, t, i, s, n, o) {
      ...
      (this._pannerNode.coneInnerAngle = a(s)),
        (this._pannerNode.coneOuterAngle = a(n)),
        (this._pannerNode.coneOuterGain = o);
    }
    SetPanXYA(e, t, i) {
      this._isPannerEnabled &&
        (this._pannerNode.setPosition(e, t, 0),
        this._pannerNode.setOrientation(Math.cos(i), Math.sin(i), 0));
    }
    SetUID(e) {
      this._instUid = e;
    }
  ...
  Play(e, t, i, s) {
    ...
    if (
      ...
      try {
        ...
        console.warn(
          `[Construct 3] Exception seeking audio '${this._buffer.GetUrl()}' to position '${i}': `,
          e
        );
      }
  ...
  (self.C3WebAudioInstance = class extends self.C3AudioInstance {
    ...
    Play(e, t, i, s) {
      (this._muteVol = 1),
        ...
        (this._isLooping = e),
        (this._playbackRate = 1),
        (this._startTime = this.GetCurrentTime() - i);
    }
    Stop() {
      ...
      SetParam(e, t, i, s) {
        switch (e) {
          case 0:
            (t = Math.max(Math.min(t / 100, 1), 0)),
              (this._params[1] = t),
              this.SetAudioParam(this._node.gain.value, 1 - t / 2, i, s),
              this.SetAudioParam(this._oscGainNode.gain.value, t / 2, i, s);
            break;
          case 7:
            (this._params[0] = t),
              this.SetAudioParam(this._oscNode.frequency, t, i, s);
    ...
    t = class extends self.DOMHandler {
      ...
      _OnReady() {
        ...
        for (const e of this._GetActiveGamepads())
          this.PostToRuntime("gamepad-connected", { index: e.index, id: e.id });
        this._isSupported && this._StartTicking();
      }
      _OnGamepadConnected(e) {
        if (!this._isReady) return;
        const t = e.gamepad;
        this.PostToRuntime("gamepad-connected", { index: t.index, id: t.id });
      }
      _OnGamepadDisconnected(e) {
        if (!this._isReady) return;
        const t = e.gamepad;
        this.PostToRuntime("gamepad-disconnected", { index: t.index });
      }
      Tick() {
      ...
      _GetGamepadByIndex(e) {
        for (const t of this._GetActiveGamepads()) if (t.index === e) return t;
        return null;
      }
...
}
{
  ...
  const s = class extends self.DOMElementHandler {
    constructor(t) {
      super(t, e),
        this.AddDOMElementMessageHandler("scroll-to-bottom", (e) =>
      ...
      return (
        "textarea" === o
          ? ((n = document.createElement("textarea")),
            (n.style.resize = "none"))
          : ((n = document.createElement("input")), (n.type = o)),
        ...
        n.addEventListener("dblclick", (t) => {
          t.stopPropagation(),
            this._PostToRuntimeElementMaybeSync("dblclick", e);
        }),
        n.addEventListener("input", () =>
          this.PostToRuntimeElement("change", e, { text: n.value })
        ),
        s.id && (n.id = s.id),
        this.UpdateState(n, s),
        n
      );
    }
    UpdateState(e, t) {
      (e.value = t.text),
        ...
        (e.title = t.title),
        (e.disabled = !t.isEnabled),
        (e.readOnly = t.isReadOnly),
        (e.spellcheck = t.spellCheck);
      const i = t.maxLength;
    ...
    CreateElement(e, i) {
      ...
      return (
        ...
        s.addEventListener("click", () =>
          this._PostToRuntimeElementMaybeSync("click", e)
        ),
        s.addEventListener("change", () =>
          this.PostToRuntimeElement("change", e, { value: parseFloat(s.value) })
        ),
        s.addEventListener("input", () =>
          this.PostToRuntimeElement("input", e, { value: parseFloat(s.value) })
        ),
        i.id && (s.id = i.id),
        this.UpdateState(s, i),
        s
      );
    }
    UpdateState(e, t) {
  ...
  const e = "browser",
    t = class extends self.DOMHandler {
      ...
      _OnNavigate(e) {
        ...
        if ("back" === t)
          ...
          const t = e.url,
            i = e.target,
            s = e.exportType;
          "windows-uwp" === s && "undefined" != typeof Windows
            ? Windows.System.Launcher.launchUriAsync(
                new Windows.Foundation.Uri(t)
              )
            : self.cordova && self.cordova.InAppBrowser
            ? self.cordova.InAppBrowser.open(t, "_system")
            : "preview" === s
          ...
          const t = e.url,
            i = e.tag;
          "windows-uwp" === e.exportType && "undefined" != typeof Windows
            ? Windows.System.Launcher.launchUriAsync(
                new Windows.Foundation.Uri(t)
              )
            : self.cordova && self.cordova.InAppBrowser
      ...
      _OnRequestFullscreen(e) {
        ...
        1 === i
          ? (t.navigationUI = "hide")
          : 2 === i && (t.navigationUI = "show");
        const s = document.documentElement;
        s.requestFullscreen
          ? s.requestFullscreen(t)
          : s.mozRequestFullScreen
          ? s.mozRequestFullScreen(t)
          : s.msRequestFullscreen
          ? s.msRequestFullscreen(t)
...
}
{
  ...
  const i = class extends self.DOMElementHandler {
    ...
    UpdateState(e, t) {
      ...
      s > 0 && i >= 0
        ? ((e.max = s), (e.value = i))
        : (e.removeAttribute("value"), e.removeAttribute("max"));
    }
  };
  self.RuntimeInterface.AddDOMHandlerClass(i);
}
  ...
  const e = "touch",
    t = class extends self.DOMHandler {
      ...
      async _OnRequestPermission(e) {
        ...
        let i = !0;
        0 === t
          ? (i = await this._RequestOrientationPermission())
          : 1 === t && (i = await this._RequestMotionPermission()),
          this.PostToRuntime("permission-result", { type: t, result: i });
      }
    ...
    t = class extends self.DOMHandler {
      ...
      _GetSafeAreaInset() {
        ...
        const i = getComputedStyle(e),
          s = [
            i.getPropertyValue("--temp-sai-top"),
            i.getPropertyValue("--temp-sai-right"),
            i.getPropertyValue("--temp-sai-bottom"),
            i.getPropertyValue("--temp-sai-left"),
          ].map((e) => {
            const t = parseInt(e, 10);
            return isFinite(t) ? t : 0;
          });
        return (
          t.removeProperty("--temp-sai-top"),
...
}
{
  ...
  const i = class extends self.DOMElementHandler {
    ...
    UpdateState(e, t) {
      ...
      (i.checked = t.isChecked),
        (i.disabled = !t.isEnabled),
        (e.title = t.title),
        e === i ? (i.value = t.text) : (e.lastChild.textContent = t.text);
    }
  };
  self.RuntimeInterface.AddDOMHandlerClass(i);
}
